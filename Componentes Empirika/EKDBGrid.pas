...
uses
  SysUtils, WinTypes, WinProcs, Messages, Classes, Graphics, Controls, Forms, Dialogs, Grids, DBGrids,DB;
...
procedure TEKDBGrid.DrawColumnCell(const Rect:TRect;DataCol:Integer; column: TColumn; State: TGridDrawState);
var
  f:TField;
...
begin
  ...
  if (f.datatype in IMAGETYPES) and Fshowimages then
    imagecell;

  if (f.datatype in MEMOTYPES) and FShowmemotext then
    memocell;
end;
