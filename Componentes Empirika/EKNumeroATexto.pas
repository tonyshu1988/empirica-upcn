...
(*** Optimizado ***)
constructor TEKNumeroALetras.Create(AOwner:TComponent);
begin
...
(*** Optimizada ***)
function TEKNumeroALetras.NumeroATexto: String;
     (*** NUEVA ***)
...
function TEKNumeroALetras.GetCentimos:String;
var
  Num_Ctvs, I: Integer;
  S: String;
  tmp: Extended;
...
procedure Register;
begin
  RegisterComponents('EmpiriKa', [TEKNumeroALetras]);
end;
