object FABM_Cuentas: TFABM_Cuentas
  ...
  object ISOrdenarGrilla1: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cuentas'
  ...
  object ISOrdenarGrilla_FPago: TISOrdenarGrilla
    Grilla = DBGridFPago
    Filtros = <
      item
    ...
    NombreGuardarConfig = 'ISOrdenarGrilla_FPago'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISBuscar: TISBusquedaAvanzada
    CriteriosBusqueda = <
      ...
      item
        ...
        TipoCombollenarSQL = ZQ_TipoMedioPago
  ...
  object ZQ_TipoMedioPago: TZQuery
    Connection = DM.Conexion
    SQL.Strings = (
      'select distinct cfp.*'
      'from cuenta_tipo_formapago cfp'
