object FEstadisticaDisponibilidades: TFEstadisticaDisponibilidades
  ...
  object PanelContenedor: TPanel
    ...
    object PageControl: TPageControl
      ...
      object TabParteDiario: TTabSheet
        ...
        object RepParteDiario: TQuickRep
          ...
          object QRSubDetail3: TQRSubDetail
            ...
            KeepOnOnePage = False
            Master = RepParteDiario
            DataSet = ZQ_SaldoCuenta_PDiario
            PrintBefore = False
            PrintIfEmpty = True
          ...
          object QRSubDetail4: TQRSubDetail
            ...
            object QRLabelDiferenciaCuenta: TQRLabel
              Left = 554
              Top = 3
              Width = 161
              Height = 17
              ...
              AutoSize = False
              AutoStretch = False
              Caption = 'QRLabelDiferenciaCuenta'
              Color = clWhite
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clWindowText
              Font.Height = -13
          ...
          object ChildBand3: TQRChildBand
            ...
            object QRLabelDiferenciaSaldos: TQRLabel
              Left = 501
              Top = 92
              Width = 170
              Height = 14
              ...
              AutoSize = False
              AutoStretch = False
              Caption = 'QRLabelDiferenciaSaldos'
              Color = clWhite
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clWindowText
              Font.Height = -11
          ...
          object Panel8: TPanel
            ...
            object Panel10: TPanel
              ...
              object GroupBox3: TGroupBox
                ...
                object lblSaldoFinalMenosInicial: TLabel
                  Left = 157
                  Top = 209
                  Width = 165
                  Height = 14
      ...
      object TabDetalleCuenta: TTabSheet
        ...
        object DBGridDetalleCuentasFPago: TDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'TOTAL_TRANSF_DEPOSITO'
              Title.Alignment = taCenter
              Title.Caption = 'Total Transf. Deposito'
              Width = 168
              Visible = True
            end>
        end
        ...
        object PanelMes: TPanel
          ...
          object DBGridBalance: TDBGrid
            ...
            Columns = <
              ...
              item
                Expanded = False
                FieldName = 'TRANSF_INGRESO'
                Title.Alignment = taCenter
                Title.Caption = 'Transf. Deposito'
                Width = 140
                Visible = True
              end
              item
                Expanded = False
                FieldName = 'TRANSF_EGRESO'
                Title.Alignment = taCenter
                Title.Caption = 'Transf. Extracci'#243'n'
                Width = 140
                Visible = True
              end
              item
  ...
  object ZP_estadistica_Parte_Diario: TZStoredProc
    ...
    object ZP_estadistica_Parte_DiarioTOTAL_DEPOSITOS: TFloatField
      FieldName = 'TOTAL_DEPOSITOS'
      ReadOnly = True
      currency = True
    end
    object ZP_estadistica_Parte_DiarioTOTAL_EXTRACCIONES: TFloatField
      FieldName = 'TOTAL_EXTRACCIONES'
      ReadOnly = True
      currency = True
    end
  end
  ...
  object ZP_Estadistica_Det_Mov: TZStoredProc
    ...
    object ZP_Estadistica_Det_MovSUCURSAL: TStringField
      FieldName = 'SUCURSAL'
      ReadOnly = True
      Size = 200
    end
  ...
  object ZQ_MovFormaPago: TZQuery
    Connection = DM.Conexion
    SQL.Strings = (
      'select tfp.descripcion as TipoFormaPago,'
      '       CASE'
        ...
        '           WHEN ((cfp.cuenta_ingreso is not null) and (cfp.cuent' +
        'a_egreso is not null)) THEN '#39'TRANSFERENCIA'#39
      '       END as cuenta, cfp.importe_real'
  ...
  object ZS_Balance: TZStoredProc
    ...
    object ZS_BalanceTRANSF_INGRESO: TFloatField
      FieldName = 'TRANSF_INGRESO'
      ReadOnly = True
      currency = True
    end
    object ZS_BalanceTRANSF_EGRESO: TFloatField
      FieldName = 'TRANSF_EGRESO'
      ReadOnly = True
      currency = True
    end
  ...
  object ZS_CalcSaldos: TZStoredProc
    ...
    object ZS_CalcSaldosTRANSF_INGRESO: TFloatField
      FieldName = 'TRANSF_INGRESO'
      ReadOnly = True
    end
    object ZS_CalcSaldosTRANSF_EGRESO: TFloatField
      FieldName = 'TRANSF_EGRESO'
      ReadOnly = True
    end
  end
  object ZQ_SaldoCuenta_PDiario: TZQuery
    Connection = DM.Conexion
    SQL.Strings = (
      
        'select ID_CUENTA, CODIGO, NOMBRE_CUENTA, NRO_CTA_BANCO, sum(SALD' +
        'O) as Saldo, sum(SALDO_ANTERIOR) as Saldo_Ant, (sum(SALDO) - sum' +
        '(SALDO_ANTERIOR)) as diferencia'
      'from SALDOS_CUENTAS2(:ID_SUCURSAL, :FECHA_DESDE,  :FECHA_HASTA)'
      'group by ID_CUENTA, CODIGO, NOMBRE_CUENTA, NRO_CTA_BANCO'
    ...
    object ZQ_SaldoCuenta_PDiarioID_CUENTA: TIntegerField
      FieldName = 'ID_CUENTA'
      ReadOnly = True
    end
    object ZQ_SaldoCuenta_PDiarioCODIGO: TStringField
      FieldName = 'CODIGO'
      ReadOnly = True
      Size = 10
    end
    object ZQ_SaldoCuenta_PDiarioNOMBRE_CUENTA: TStringField
      FieldName = 'NOMBRE_CUENTA'
      ReadOnly = True
      Size = 50
    end
    object ZQ_SaldoCuenta_PDiarioNRO_CTA_BANCO: TStringField
      FieldName = 'NRO_CTA_BANCO'
      ReadOnly = True
      Size = 10
    end
    object ZQ_SaldoCuenta_PDiarioSALDO: TFloatField
      FieldName = 'SALDO'
      ReadOnly = True
      currency = True
    end
    object ZQ_SaldoCuenta_PDiarioDIFERENCIA: TFloatField
      FieldName = 'DIFERENCIA'
      ReadOnly = True
      currency = True
    end
    object ZQ_SaldoCuenta_PDiarioSALDO_ANT: TFloatField
      FieldName = 'SALDO_ANT'
      ReadOnly = True
      currency = True
    end
  end
  object DS_SaldoCuenta_PDiario: TDataSource
    DataSet = ZQ_SaldoCuenta_PDiario
    Left = 390
    Top = 247
  end
  object ZQ_Detalle_Cuenta: TZQuery
    Connection = DM.Conexion
    AfterScroll = ZQ_Detalle_CuentaAfterScroll
    SQL.Strings = (
    ...
    object ZQ_Detalle_CuentaID_CUENTA: TIntegerField
      FieldName = 'ID_CUENTA'
      ReadOnly = True
    end
    object ZQ_Detalle_CuentaCODIGO: TStringField
      FieldName = 'CODIGO'
      ReadOnly = True
      Size = 10
    end
    object ZQ_Detalle_CuentaNOMBRE_CUENTA: TStringField
      FieldName = 'NOMBRE_CUENTA'
      ReadOnly = True
      Size = 50
    end
    object ZQ_Detalle_CuentaNRO_CTA_BANCO: TStringField
      FieldName = 'NRO_CTA_BANCO'
      ReadOnly = True
      Size = 10
    end
    object ZQ_Detalle_CuentaSALDO: TFloatField
      FieldName = 'SALDO'
      ReadOnly = True
      currency = True
    end
    object ZQ_Detalle_CuentaSALDO_ANT: TFloatField
      FieldName = 'SALDO_ANT'
      ReadOnly = True
      currency = True
    end
    object ZQ_Detalle_CuentaDIFERENCIA: TFloatField
      FieldName = 'DIFERENCIA'
      ReadOnly = True
      currency = True
    end
  end
  object DS_Detalle_Cuenta: TDataSource
    DataSet = ZQ_Detalle_Cuenta
    Left = 389
    Top = 497
  end
  object ZP_Detalle_Cuenta_FPago: TZStoredProc
    ...
    Params = <
      ...
      item
        DataType = ftFloat
        Name = 'TOTAL_TRANSF_EXTRACCION'
        ParamType = ptResult
      end
      item
        DataType = ftFloat
        Name = 'TOTAL_TRANSF_DEPOSITO'
        ParamType = ptResult
      end
      item
        DataType = ftDate
    ...
    StoredProcName = 'ESTADISTICA_IE_MEDIO_POR_CUENTA'
    Left = 525
    Top = 439
    ParamData = <
      item
    ...
    object ZP_Detalle_Cuenta_FPagoDESCRIPCION: TStringField
      FieldName = 'DESCRIPCION'
      ReadOnly = True
      Size = 100
    end
    object ZP_Detalle_Cuenta_FPagoTOTAL_EGRESO: TFloatField
      FieldName = 'TOTAL_EGRESO'
      ReadOnly = True
      currency = True
    end
    object ZP_Detalle_Cuenta_FPagoTOTAL_INGRESO: TFloatField
      FieldName = 'TOTAL_INGRESO'
      ReadOnly = True
      currency = True
    end
    object ZP_Detalle_Cuenta_FPagoTOTAL_TRANSF_DEPOSITO: TFloatField
      FieldName = 'TOTAL_TRANSF_DEPOSITO'
      ReadOnly = True
      currency = True
    end
    object ZP_Detalle_Cuenta_FPagoTOTAL_TRANSF_EXTRACCION: TFloatField
      FieldName = 'TOTAL_TRANSF_EXTRACCION'
      ReadOnly = True
      currency = True
    end
  ...
  object ISVista_RepSaldo: TISVistaPreviaQR
    Reporte = RepSaldo
    ShowModal = False
    Left = 53
    Top = 297
  end
  object ISVista_RepDetMov: TISVistaPreviaQR
    Reporte = RepDetalleMov
    ShowModal = False
    Left = 205
    Top = 304
  end
  object ISVista_RepParteDiario: TISVistaPreviaQR
    Reporte = RepParteDiario
    ShowModal = False
    Left = 533
    Top = 297
  end
  object ISVistaBalance: TISVistaPreviaQR
    Reporte = RepBalance
    ShowModal = False
    Left = 853
    Top = 305
  end
  object ISOrdenarGrillaSaldos: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'DBGridSaldoCuentas'
  ...
  object ISOrdenarGrillaDetMov: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'DBGridEstadisticaDetMov'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrdenarMovFPago: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ISOrdenarMovFPago'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrdenarGrillaPD_Saldo: TISOrdenarGrilla
    ...
    Filtros = <
      ...
      item
        TituloColumna = 'Saldo Final'
        Visible = True
      end
      item
        TituloColumna = 'Saldo Anterior'
        Visible = True
      end
      item
        TituloColumna = 'Diferencia'
        Visible = True
      end>
    NombreGuardarConfig = 'DBGridPD_SaldoCuentas'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISDbSuma_Saldo: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'IMPORTE'
  ...
  object ISSumaPD_SaldoCta: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'SALDO'
  ...
  object ISDbSuma_ParteDiario: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
  ...
  object ISSuma_Balance: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'INGRESO'
      ...
      item
        Operacion = goSum
        NombreCampo = 'TRANSF_INGRESO'
      end
      item
        Operacion = goSum
        NombreCampo = 'TRANSF_EGRESO'
      end>
    DataSet = ZS_Balance
    Left = 853
    Top = 193
  end
  object IS_SUMA_Detalle_Cuenta_FPago: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'diferencia'
  ...
  object ISBuscarSaldo: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'Sucursal'
  ...
  object ISBuscarDetMov: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'Sucursal'
        TipoCampoIngreso = IS_Combo
  ...
  object ISBuscarParteDiario: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'Sucursal'
        TipoCampoIngreso = IS_Combo
  ...
  object ISBuscarDetalleCuenta: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'Sucursal'
        TipoCampoIngreso = IS_Combo
  ...
  object ISBuscarBalance: TISBusquedaAvanzada
    CriteriosBusqueda = <
      ...
      item
        ...
        TipoCombollenarCampo = 'NOMBRE_CUENTA'
