object FABM_CPB_NotaPedido: TFABM_CPB_NotaPedido
          ...
          object DBGridCpbActual_Producto: TDBGrid
            ...
            Columns = <
              ...
              item
                ...
                Title.Caption = 'Precio Anterior'
                Visible = True
              end
              item
                Expanded = False
                FieldName = 'diferencia_precios'
                Title.Caption = 'Diferencia Precios'
                Visible = True
              end>
          end
      ...
      object PanelEditar_DatosGral: TPanel
        ...
        object PanelFechas: TPanel
          ...
          object PanelFechaImpreso: TPanel
            ...
            object ISDBDateImpreso: TISDBDateTimePicker
              Left = 12
              Top = 14
              Width = 105
              Height = 21
              Date = 41834.491588553240000000
              Time = 41834.491588553240000000
              TabOrder = 0
              DataField = 'FECHA_IMPRESA'
              DataSource = DS_Comprobante
            end
          ...
          object PanelFechaEnviado: TPanel
            ...
            object ISDBDateEnviado: TISDBDateTimePicker
              ...
              Width = 105
              Height = 21
              Date = 41834.491541435190000000
              Time = 41834.491541435190000000
              TabOrder = 0
              DataField = 'FECHA_ENVIADA'
              DataSource = DS_Comprobante
            end
          ...
          object PanelFechaEmision: TPanel
            ...
            object ISDBDateEmision: TISDBDateTimePicker
              ...
              Width = 105
              Height = 21
              Date = 41834.491391331020000000
              Time = 41834.491391331020000000
              TabOrder = 0
              DataField = 'FECHA'
              DataSource = DS_Comprobante
            end
  ...
  object dxBarABM: TdxBarManager
    ...
    object btStock_max: TdxBarLargeButton
      Caption = 'Stock Max'
      Category = 0
      Hint = 'Stock Max'
      Visible = ivAlways
      LargeImageIndex = 75
      OnClick = btStock_maxClick
      AutoGrayScale = False
    end
  ...
  object ZQ_CpbProducto: TZQuery
    ...
    object ZQ_CpbProductoIMPORTE_COSTO: TFloatField
      FieldName = 'IMPORTE_COSTO'
      currency = True
    end
  end
  ...
  object ZQ_VerCpb_Producto: TZQuery
    ...
    OnCalcFields = ZQ_VerCpb_ProductoCalcFields
    SQL.Strings = (
      ...
      '       color.nombre as color, marca.nombre_marca as marca,'
        ...
        '       cpbd.importe_unitario, cpbd.cantidad_recibida, cpbd.canti' +
        'dad_almacenada, cpbd.importe_costo'
      'from comprobante_detalle cpbd'
    ...
    object ZQ_VerCpb_Productodiferencia_precios: TFloatField
  ...
  object ZSP_Stock_Max: TZStoredProc
    ...
    StoredProcName = 'NOTA_PEDIDO_STOCK_MAXIMO'
    Left = 277
    Top = 353
    ParamData = <
      item
    ...
    object ZSP_Stock_MaxSUPERA: TFloatField
      FieldName = 'SUPERA'
      ReadOnly = True
    end
  end
  object ISOrd_VerCpb_Producto: TISOrdenarGrilla
    ...
    Filtros = <
      ...
      item
        TituloColumna = 'Almacenado'
        Visible = True
      end
      item
        TituloColumna = 'Precio Recibido'
        Visible = True
      end
      item
        TituloColumna = 'Precio Anterior'
        Visible = True
      end
      item
        TituloColumna = 'Diferencia Precios'
        Visible = True
      end>
    NombreGuardarConfig = 'ABM_NP_VerProductos'
  ...
  object ISOrd_EditarProducto: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_NP_EditarProductos'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrd_VerCpb: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_NP_VerCpb'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISListadoPosicionSucursal: TISListadoSQL
    Modelo = DM.ISModelo
    CampoBuscar = 'seccion'
    CampoClave = 'id_posicion_sucursal'
    TituloVentana = 'Seleccione la Posicion sucursal que desea Controlar'
