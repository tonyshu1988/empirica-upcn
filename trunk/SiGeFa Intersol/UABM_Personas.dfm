object FABM_Personas: TFABM_Personas
      ...
      object PageControl: TPageControl
        ...
        object TabSheetObraSocial: TTabSheet
          ...
          object DBGridObraSocial: TDBGrid
            ...
            Columns = <
              ...
              item
                ...
                Title.Caption = 'Plan Obra Social'
                Width = 453
                Visible = True
              end
              item
          ...
          object Panel1: TPanel
            ...
            BevelOuter = bvNone
            TabOrder = 1
            object stDescFinalOss: TStaticText
              Left = 801
              Top = 0
              Width = 137
              Height = 16
  ...
  object ZQ_Persona: TZQuery
    ...
    object ZQ_PersonaCODIGO_CORTO: TStringField
      FieldName = 'CODIGO_CORTO'
    end
    object ZQ_PersonaIMPORTADO: TStringField
      FieldName = 'IMPORTADO'
      Size = 1
    end
    object ZQ_PersonaNRO_AFILIADO: TStringField
      FieldName = 'NRO_AFILIADO'
    end
  end
  ...
  object ZQ_PersonaObraSocial: TZQuery
    ...
    object ZQ_PersonaObraSocialPORC_FINAL: TStringField
      FieldName = 'PORC_FINAL'
      Size = 1
    end
  end
  ...
  object ZQ_ObraSocial: TZQuery
    ...
    object ZQ_ObraSocialDESCUENTO: TFloatField
      FieldName = 'DESCUENTO'
    end
  end
  object PopupMenuObraSocial: TPopupMenu
    ...
    object DescuentaalFinal1: TMenuItem
      Caption = 'Descuento Mutual'
      OnClick = DescuentaalFinal1Click
    end
  end
  ...
  object ISListadoObraSocial: TISListadoSQL
    ...
    SQL.Strings = (
        ...
        'Select oss.ID_OS,(osc.nombre ||'#39' : '#39'||oss.codigo||'#39' - '#39'|| oss.no' +
        'mbre) as nombre'
      'from Optica_os oss'
