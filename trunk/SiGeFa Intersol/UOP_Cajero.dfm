object FOP_Cajero: TFOP_Cajero
  ...
  object PLeerCodigo: TPanel
    ...
    object Label19: TLabel
      ...
      Width = 128
      Height = 12
      Caption = 'I# : Id de Producto Stock'
      Font.Charset = ANSI_CHARSET
      Font.Color = clNavy
      Font.Height = -9
      Font.Name = 'Verdana'
  ...
  object dxBarABM: TdxBarManager
    ...
    object btnCargarOrdenTecnica: TdxBarLargeButton
      ...
      Visible = ivAlways
      LargeImageIndex = 90
      OnClick = btnCargarOrdenTecnicaClick
      AutoGrayScale = False
    end
  ...
  object ZQ_ComprobanteDetalle: TZQuery
    ...
    object ZQ_ComprobanteDetalleID_AUXILIAR: TIntegerField
      FieldName = 'ID_AUXILIAR'
    end
    object ZQ_ComprobanteDetalleIMPORTE_RECONOC_OS: TFloatField
  ...
  object ZQ_OrdenProductos: TZQuery
    ...
    object ZQ_OrdenProductosIMPORTE_VENTA: TFloatField
      FieldName = 'IMPORTE_VENTA'
    end
    object ZQ_OrdenProductosIMPORTE_UNITARIO: TFloatField
      FieldName = 'IMPORTE_UNITARIO'
    end
    object ZQ_OrdenProductosIMPORTE_TOTAL: TFloatField
      FieldName = 'IMPORTE_TOTAL'
    end
  end
  object ZQ_OpticaEntrega: TZQuery
    ...
    object ZQ_OpticaEntregaID_ENTREGA: TIntegerField
      FieldName = 'ID_ENTREGA'
      Required = True
    end
    object ZQ_OpticaEntregaID_ORDEN: TIntegerField
      FieldName = 'ID_ORDEN'
      Required = True
    end
    object ZQ_OpticaEntregaID_TIPO_FORMAPAG: TIntegerField
      FieldName = 'ID_TIPO_FORMAPAG'
      Required = True
    end
    object ZQ_OpticaEntregaMDCP_FECHA: TDateField
      FieldName = 'MDCP_FECHA'
    end
    object ZQ_OpticaEntregaMDCP_BANCO: TStringField
      FieldName = 'MDCP_BANCO'
      Size = 50
    end
    object ZQ_OpticaEntregaMDCP_CHEQUE: TStringField
      FieldName = 'MDCP_CHEQUE'
      Size = 50
    end
    object ZQ_OpticaEntregaIMPORTE: TFloatField
      FieldName = 'IMPORTE'
    end
    object ZQ_OpticaEntregaCONCILIADO: TDateField
      FieldName = 'CONCILIADO'
    end
    object ZQ_OpticaEntregaCUENTA_INGRESO: TIntegerField
      FieldName = 'CUENTA_INGRESO'
    end
    object ZQ_OpticaEntregaCUENTA_EGRESO: TIntegerField
      FieldName = 'CUENTA_EGRESO'
    end
    object ZQ_OpticaEntregaFECHA_FP: TDateTimeField
      FieldName = 'FECHA_FP'
    end
    object ZQ_OpticaEntregaIMPORTE_REAL: TFloatField
      FieldName = 'IMPORTE_REAL'
    end
    object ZQ_OpticaEntregaID_RECIBO_OP: TIntegerField
      FieldName = 'ID_RECIBO_OP'
    end
    object ZQ_OpticaEntregaINSERT_MANUAL: TStringField
      FieldName = 'INSERT_MANUAL'
      Size = 1
    end
  end
  object ZQ_Optica_Orden: TZQuery
    ...
    object ZQ_Optica_OrdenFECHA_ORDEN: TDateField
      FieldName = 'FECHA_ORDEN'
    end
    object ZQ_Optica_OrdenFECHA_PROMETIDO: TDateField
      FieldName = 'FECHA_PROMETIDO'
    end
    object ZQ_Optica_OrdenID_ESTADO: TIntegerField
      FieldName = 'ID_ESTADO'
      Required = True
    end
    object ZQ_Optica_OrdenFACTURADO_POR: TIntegerField
    ...
    object ZQ_Optica_OrdenCODIGO_CLI: TStringField
      FieldName = 'CODIGO_CLI'
      Size = 50
    end
    object ZQ_Optica_OrdenID_CLIENTE: TIntegerField
      FieldName = 'ID_CLIENTE'
      Required = True
    end
    object ZQ_Optica_OrdenCOD_BARRAS: TStringField
      FieldName = 'COD_BARRAS'
      Size = 100
    end
    object ZQ_Optica_OrdenOBSERVACIONES: TStringField
      FieldName = 'OBSERVACIONES'
      Size = 5000
    end
    object ZQ_Optica_OrdenNRO_FACTURA: TStringField
    ...
    object ZQ_Optica_OrdenENTREGADO_POR: TIntegerField
      FieldName = 'ENTREGADO_POR'
    end
    object ZQ_Optica_OrdenID_MEDICO: TIntegerField
      FieldName = 'ID_MEDICO'
    end
    ...
    object ZQ_Optica_OrdenID_SUCURSAL: TIntegerField
      FieldName = 'ID_SUCURSAL'
    end
  end
  ...
  object ISListadoIVA: TISListadoSQL
    SQL.Strings = (
  ...
  object ISDbSumaDetalleFactura: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
    ...
    DataSet = CD_DetalleFactura
    SumListChanged = ISDbSumaDetalleFacturaSumListChanged
    Left = 1018
    Top = 349
  end
  object ISDbSumaVentaFinal: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
  ...
  object PopupReconocim: TPopupMenu
    Images = FPrincipal.Iconos_Menu_16
    MenuAnimation = [maLeftToRight]
    Left = 928
    Top = 504
    object popReconocimAgregar: TMenuItem
      Caption = 'Agregar Reconocimiento'
      ImageIndex = 10
      OnClick = popReconocimAgregarClick
    end
    object popReconocimQuitar: TMenuItem
      Caption = 'Quitar Reconocimiento'
      ImageIndex = 12
      OnClick = popReconocimQuitarClick
    end
  end
  object DS_Reconocimientos: TDataSource
    DataSet = CD_Reconocimientos
    Left = 1018
    Top = 500
  end
  object ZQ_ReconocimOSS: TZQuery
    ...
    SQL.Strings = (
      'select ors.*'
      'from optica_reconocimiento_oss ors'
      '')
    Params = <>
    Left = 1017
    Top = 241
  ...
  object ZQ_planes_productos: TZQuery
    ...
    SQL.Strings = (
        ...
        'Select opr.*,(osc.nombre ||'#39' : '#39'||oss.codigo||'#39' - '#39'|| oss.nombre' +
        ') as detalle'
      'from optica_productos_reconocidos opr'
      'join Optica_os oss on (opr.id_os=oss.id_os)'
      
        'join optica_os_cabecera osc on (oss.id_optica_os_cabecera=osc.id' +
        '_optica_os_cabecera)'
      'where (oss.baja='#39'N'#39')and(opr.id_producto=:idProd)and'
      
        '(oss.id_os in (select distinct opp.id_os from optica_persona_os ' +
        'opp where (opp.id_persona=:idPers)))'
      '')
    Params = <
      item
        DataType = ftUnknown
    ...
    object ZQ_planes_productosDETALLE: TStringField
      FieldName = 'DETALLE'
      ReadOnly = True
      Size = 506
    end
  end
  object DS_planes_productos: TDataSource
    DataSet = ZQ_planes_productos
    Left = 736
    Top = 190
  end
  object CD_Reconocimientos: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DataSetProvider2'
    Left = 1000
    Top = 446
    object CD_Reconocimientosid_os: TIntegerField
      FieldName = 'id_os'
    end
    object CD_Reconocimientosmonto_reconocido: TFloatField
      FieldName = 'monto_reconocido'
      DisplayFormat = '$ ##,###,##0.00'
      EditFormat = '##,###,##0.00'
    end
    object CD_Reconocimientosdetalle: TStringField
      FieldName = 'detalle'
      Size = 500
    end
    object CD_Reconocimientosid_prod: TIntegerField
      FieldName = 'id_prod'
    end
  end
  object ISDbSumaReconocim: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
    ...
    DataSet = CD_Reconocimientos
    SumListChanged = ISDbSumaReconocimSumListChanged
    Left = 1017
    Top = 198
  end
  object ZQ_DctoMutual: TZQuery
    Connection = DM.Conexion
    AfterOpen = ZQ_DctoMutualAfterOpen
    AfterClose = ZQ_DctoMutualAfterClose
    SQL.Strings = (
      
        'select first 1 opo.*,(osc.nombre ||'#39' : '#39'||oss.codigo||'#39' - '#39'|| os' +
        's.nombre) as nombre'
      'from optica_persona_os opo'
      'join optica_os oss on (oss.id_os=opo.id_os)'
      
        'join optica_os_cabecera osc on (oss.id_optica_os_cabecera=osc.id' +
        '_optica_os_cabecera)'
      'where (opo.id_persona=:idPers)and(opo.porc_final='#39'S'#39')'
      '')
    Params = <
      item
        DataType = ftUnknown
    ...
    object ZQ_DctoMutualID_PERSONA_OS: TIntegerField
      FieldName = 'ID_PERSONA_OS'
      Required = True
    end
    object ZQ_DctoMutualNRO_AFILIADO: TStringField
      FieldName = 'NRO_AFILIADO'
      Size = 100
    end
    object ZQ_DctoMutualID_OS: TIntegerField
      FieldName = 'ID_OS'
      Required = True
    end
    object ZQ_DctoMutualID_PERSONA: TIntegerField
      FieldName = 'ID_PERSONA'
      Required = True
    end
    object ZQ_DctoMutualDESCUENTO: TFloatField
      FieldName = 'DESCUENTO'
    end
    object ZQ_DctoMutualPORC_FINAL: TStringField
      FieldName = 'PORC_FINAL'
      Size = 1
    end
    object ZQ_DctoMutualNOMBRE: TStringField
      FieldName = 'NOMBRE'
      ReadOnly = True
      Size = 506
    end
  end
  object ZSP_Comprobante_Detalle: TZStoredProc
    Connection = DM.Conexion
    Params = <
      item
        DataType = ftInteger
    ...
    StoredProcName = 'SP_GEN_COMPROBANTE_DETALLE_ID'
    Left = 537
    Top = 281
    ParamData = <
      item
    ...
    object ZSP_Comprobante_DetalleID: TIntegerField
      FieldName = 'ID'
      ReadOnly = True
    end
  end
