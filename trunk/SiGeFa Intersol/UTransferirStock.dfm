object FTransferirStock: TFTransferirStock
  ...
  object dxBarABM: TdxBarManager
    ...
    object dxBarABMBar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnNotaPedido'
        end
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnTransferir'
        end
        item
          BeginGroup = True
          Visible = True
        ...
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnVerTransferencias'
        end
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnBuscarHistorico'
        end
        item
          BeginGroup = True
          Visible = True
    ...
    object btnBuscarHistorico: TdxBarLargeButton
      Caption = 'Buscar Historico'
      Category = 0
      Hint = 'Buscar Historico'
      Visible = ivNever
      LargeImageIndex = 29
      OnClick = btnBuscarHistoricoClick
      AutoGrayScale = False
    end
  ...
  object ZQ_Historico_Cpb: TZQuery
    ...
    UpdateObject = ZUpdateSQLHistoricoCpb
    SQL.Strings = (
    ...
    object ZQ_Historico_CpbFECHA_IMPRESA: TDateField
      FieldName = 'FECHA_IMPRESA'
    end
  end
  ...
  object ZUpdateSQLHistoricoCpb: TZUpdateSQL
    DeleteSQL.Strings = (
      'DELETE FROM comprobante'
      'WHERE'
      '  comprobante.ID_COMPROBANTE = :OLD_ID_COMPROBANTE')
    InsertSQL.Strings = (
    ...
    ParamData = <
      ...
      item
        DataType = ftUnknown
        Name = 'OLD_ID_COMPROBANTE'
        ParamType = ptUnknown
      end>
  end
  object ISOrdenarGrillaProductos: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'TransferirStock_Productos'
  ...
  object ISOrdenarGrillaNotaPedidoDetalle: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'TransferirStock_NotaPedido'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISSumaNotaPedido: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
  ...
  object ISSumaTransferir: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
  ...
  object ISOrdenarHistorico_Detalle: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ISOrdenarHistorico_Detalle'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrdenarHistorico_Cpb: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ISOrdenarHistorico_Cpb'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISBusquedaHistorico: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'Comprobante'
        Campo = 'codigo'
