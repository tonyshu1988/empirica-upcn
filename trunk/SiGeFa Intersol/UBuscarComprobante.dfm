object FBuscarComprobante: TFBuscarComprobante
  ...
  object ZQ_Factura_Compra: TZQuery
    ...
    SQL.Strings = (
        ...
        'select distinct c.id_comprobante, c.id_proveedor, lpad(c.punto_v' +
        'enta,4,'#39'0'#39')||'#39'-'#39'||lpad(c.numero_cpb,8,'#39'0'#39') as codigo,'
      
        '       cast(c.fecha_cobrada as Date) fecha, c.importe_venta, cfp' +
        '.importe_real,'
      '       case'
      
        '        when (c.id_tipo_cpb = 13) then '#39'FACTURA '#39'||lpad(c.punto_' +
        'venta,4,'#39'0'#39')||'#39'-'#39'||lpad(c.numero_cpb,8,'#39'0'#39')'
      '        when (c.id_tipo_cpb = 26) then c.observacion'
      '       end as Descripcion'
      'from comprobante c'
      ...
      'left join producto pr on (cd.id_producto = pr.id_producto)'
        ...
        'where ((c.id_tipo_cpb = 13 and cfp.cuenta_egreso = 1) or (c.id_t' +
        'ipo_cpb = 26))'
      '  and cfp.importe_real <> 0'
      '  and c.fecha_anulado is null'
  ...
  object ISDbSumaVenta: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
  ...
  object ISDbSumaCompra: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'IMPORTE_REAL'
  ...
  object ISOrdenarGrilla: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'BuscarProducto'
  ...
  object ISBuscarFacturaVenta: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
  ...
  object ISBuscarFacturaCompra: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'Fecha Factura'
        Campo = 'fecha'
