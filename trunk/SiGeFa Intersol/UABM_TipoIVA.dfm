object FABM_TipoIVA: TFABM_TipoIVA
  Left = 366
  Top = 429
  Width = 870
  Height = 500
  ...
  object PanelFondo: TPanel
    ...
    object PanelGrilla: TPanel
      ...
      object DBGridTipoIva: TDBGrid
        ...
        TitleFont.Style = []
        OnDrawColumnCell = DBGridTipoIvaDrawColumnCell
        Columns = <
          item
            Expanded = False
  ...
  object ISOrdenarGrilla1: TISOrdenarGrilla
    ...
    Filtros = <
      ...
      item
        TituloColumna = 'Abreviatura'
        Visible = True
      end
      item
        TituloColumna = 'Discriminar'
        Visible = True
      end
      item
        TituloColumna = 'Letra'
      ...
      item
        TituloColumna = 'Verifica'
        Visible = True
      end>
    NombreGuardarConfig = 'ABM_TipoIva'
