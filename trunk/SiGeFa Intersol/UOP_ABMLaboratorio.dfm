object FOP_ABMLaboratorio: TFOP_ABMLaboratorio
  ...
  object ZQ_Laboratorio: TZQuery
    Connection = DM.Conexion
    SQL.Strings = (
      'select S.*'
      'from OPTICA_LABORATORIO S'
      'order by s.nombre')
    Params = <>
    Left = 48
    Top = 64
    object ZQ_LaboratorioID_LABORATORIO: TIntegerField
      FieldName = 'ID_LABORATORIO'
    end
    object ZQ_LaboratorioNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 200
    end
    object ZQ_LaboratorioDIRECCION: TStringField
      FieldName = 'DIRECCION'
      Size = 100
    end
    object ZQ_LaboratorioTELEFONO: TStringField
      FieldName = 'TELEFONO'
      Size = 100
    end
    object ZQ_LaboratorioCODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 50
    end
    object ZQ_LaboratorioBAJA: TStringField
      FieldName = 'BAJA'
      Size = 1
    end
  end
  ...
  object ISOrdenarGrilla1: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'EkOG_ABMLaboratorio'
