...
uses
  ...
  QRCtrls, QuickRpt, Buttons, ImgList, ComCtrls, ZStoredProcedure,
  DBClient, Menus, UBuscarProducto, UBuscarPersona, cxClasses,
  ISOrdenarGrilla, ISDbSuma, ISListadoSQL, ISBusquedaAvanzada,
  ISDBDateTimePicker;
...
begin
  ...
  if dm.ISIni.LeerRegnumero('PRESUP_PanelEditar_DatosGral_Height') <> 0 then
    PanelEditar_DatosGral.Height:= dm.ISIni.LeerRegnumero('PRESUP_PanelEditar_DatosGral_Height');
end;
...
begin
  ...
  ZQ_ComprobanteIMPORTE_TOTAL.AsFloat:= ISSuma_Productos.SumCollection[2].SumValue;
...
begin
  ...
  total:= FormatFloat('$ ###,###,###,##0.00', ISSuma_Productos.SumCollection[2].SumValue);
  desc:= FormatFloat('$ ###,###,###,##0.00', ISSuma_Productos.SumCollection[1].SumValue - ISSuma_Productos.SumCollection[2].SumValue);
...
begin
  ...
  dm.ISIni.EsribirRegEntero('PRESUP_PanelEditar_DatosGral_Height', PanelEditar_DatosGral.Height);  
end;
