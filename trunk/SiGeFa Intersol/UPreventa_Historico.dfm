object FPreventa_Historico: TFPreventa_Historico
  Left = 276
  Top = 265
  Width = 966
  Height = 634
  Caption = 'Historico Preventas'
  Color = clBtnFace
          ...
          object DBGridComprobantes: TDBGrid
            ...
            Columns = <
              ...
              item
                Alignment = taCenter
                Expanded = False
                FieldName = 'FECHA_USADO'
                Title.Alignment = taCenter
                Title.Caption = 'Utilizada'
                Width = 111
                Visible = True
              end
              item
        ...
        object PanelFPagoYProd: TPanel
          ...
          object PanelProducto: TPanel
            ...
            object DBGridListadoProductos: TDBGrid
              ...
              TitleFont.Name = 'Verdana'
              TitleFont.Style = []
              OnDrawColumnCell = DBGridListadoProductosDrawColumnCell
              Columns = <
                item
                  Expanded = False
          ...
          object PanelFpago: TPanel
            ...
            object DBGridFormaPago: TDBGrid
              ...
              TitleFont.Name = 'Verdana'
              TitleFont.Style = []
              OnDrawColumnCell = DBGridFormaPagoDrawColumnCell
              Columns = <
                item
                  Expanded = False
  ...
  object ZQ_Comprobante: TZQuery
    ...
    SQL.Strings = (
      'select distinct c.codigo, c.id_comprobante,'
        ...
        '       c.fecha fecha_carga, cast(c.fecha_cobrada as date) as Fec' +
        'ha_usado,'
    ...
    object ZQ_ComprobanteFECHA_CARGA: TDateTimeField
      FieldName = 'FECHA_CARGA'
    end
    object ZQ_ComprobanteFECHA_USADO: TDateField
      FieldName = 'FECHA_USADO'
    end
    object ZQ_ComprobanteFECHA_VENC: TDateField
      FieldName = 'FECHA_VENC'
    end
  ...
  object ISMensajeMasDato1: TISMensajeMasDato
    TipoDato = FtDate
