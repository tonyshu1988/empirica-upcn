object FABM_ArticuloMedida: TFABM_ArticuloMedida
  ...
  object PanelFondo: TPanel
    ...
    object RepMedida: TQuickRep
      ...
      object QRBand9: TQRBand
        ...
        object RepMedida_Subtitulo: TQRLabel
          Left = 288
          Top = 26
          Width = 142
          Height = 20
        ...
        object RepMedida_Titulo: TQRLabel
          Left = 279
          Top = 2
          Width = 159
          Height = 20
      ...
      object QRBand12: TQRBand
        ...
        object QRExpr18: TQRExpr
          ...
          Transparent = False
          WordWrap = True
          Expression = #39'Cantidad de Medidas: '#39'+COUNT'
          ExportAs = exptText
          FontSize = 8
        end
      end
    ...
    object dxBarABMBar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnGuardarCarga'
        end
        item
          Visible = True
          ItemName = 'btnCancelarCarga'
        end
        item
          BeginGroup = True
          Visible = True
  ...
  object ISListadoArticulo: TISListadoSQL
    ...
    SQL.Strings = (
        ...
        'select articulo.*, tipo_articulo.descripcion||'#39' - '#39'||articulo.de' +
        'scripcion as busqueda'
      'from articulo'
      
        'left join tipo_articulo on (articulo.id_tipo_articulo = tipo_art' +
        'iculo.id_tipo_articulo)'
      'where articulo.baja = '#39'N'#39)
    CampoBuscar = 'BUSQUEDA'
    CampoClave = 'ID_ARTICULO'
    TituloVentana = 'Buscar Art'#237'culo'
    TituloBuscar = 'Art'#237'culo'
  ...
  object ISLlenarComboArticulo: TISLlenarCombo
    dataset = ZQ_Articulo
    combo = CBArticulo
    OnCambio = ISLlenarComboArticuloCambio
    CampoClave = 'id_articulo'
    CampoVer = 'busqueda'
