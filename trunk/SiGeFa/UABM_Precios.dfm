object FABM_Precios: TFABM_Precios
  ...
  object dxBarABM: TdxBarManager
    ...
    object dxBarABMBar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'btnEditarGrilla'
        end
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnProcesarImportes'
        end
        item
          Visible = True
          ItemName = 'btnExpImp'
  ...
  object ZP_UpdateInsert_Precios: TZStoredProc
    ...
    object ZP_UpdateInsert_PreciosCANT_U: TIntegerField
      FieldName = 'CANT_U'
      ReadOnly = True
    end
    object ZP_UpdateInsert_PreciosCANT_I: TIntegerField
      FieldName = 'CANT_I'
      ReadOnly = True
    end
  end
