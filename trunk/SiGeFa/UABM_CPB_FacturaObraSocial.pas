...
procedure TFABM_CPB_FacturaObraSocial.PopUpItem_ProductoOcultarDetalleClick(Sender: TObject);
begin
...
procedure TFABM_CPB_FacturaObraSocial.ZQ_VerCpb_ProductoAfterScroll(DataSet: TDataSet);
begin
