object FCuentaCorrienteProveedor: TFCuentaCorrienteProveedor
  ...
  object PanelResumen: TPanel
    ...
    object PanelResumen_Abajo: TPanel
      ...
      object Panel1: TPanel
        ...
        object ISEditResumen_Cantidad: TISEdit
          Tag = 99
          Left = 2
          Top = 15
          Width = 145
        ...
        object ISEditResumen_Debe: TISEdit
          Tag = 99
          Left = 150
          Top = 15
          Width = 145
        ...
        object ISEditResumen_Haber: TISEdit
          Tag = 99
          Left = 296
          Top = 15
          Width = 145
        ...
        object ISEditResumen_Saldo: TISEdit
          Tag = 99
          Left = 444
          Top = 15
          Width = 145
  ...
  object PanelProveedor: TPanel
    ...
    object PanelProveedor_Resumen: TPanel
      ...
      object PanelProveedor_ResumenFiltro: TPanel
        ...
        object ISEdit_CantidadFiltro: TISEdit
          Tag = 99
          Left = 26
          Top = 14
          Width = 121
        ...
        object ISEdit_DebeFiltro: TISEdit
          Tag = 99
          Left = 150
          Top = 13
          Width = 145
        ...
        object ISEdit_HaberFiltro: TISEdit
          Tag = 99
          Left = 296
          Top = 13
          Width = 145
        ...
        object ISEdit_SaldoFiltro: TISEdit
          Tag = 99
          Left = 444
          Top = 13
          Width = 145
      ...
      object PanelProveedor_ResumenTotales: TPanel
        ...
        object ISEdit_DebeTotal: TISEdit
          Tag = 99
          Left = 150
          Top = 11
          Width = 145
        ...
        object ISEdit_HaberTotal: TISEdit
          Tag = 99
          Left = 296
          Top = 11
          Width = 145
        ...
        object ISEdit_SaldoTotal: TISEdit
          Tag = 99
          Left = 444
          Top = 11
          Width = 145
    ...
    object PanelProveedor_CtaCte: TPanel
      ...
      object PanelDetalleMov: TPanel
        ...
        object DBGridDetalle_OP: TDBGrid
          ...
          Align = alClient
          Color = 14606012
          DataSource = DS_OrdenPagoDetalle
          Options = [dgTitles, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
          TabOrder = 0
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          ...
          TitleFont.Name = 'Verdana'
          TitleFont.Style = []
          OnDrawColumnCell = DBGridDetalle_OPDrawColumnCell
          Columns = <
            item
              Expanded = False
              FieldName = 'FECHA'
  ...
  object PanelFiltroFechas: TPanel
    ...
    object ISDBDateTime_FiltroDesde: TISDBDateTimePicker
      Left = 54
      Top = 21
      Width = 115
      Height = 21
      Date = 41836.378459282410000000
      Time = 41836.378459282410000000
      TabOrder = 2
    end
    object ISDBDateTime_FiltroHasta: TISDBDateTimePicker
      Left = 54
      Top = 49
      Width = 115
      Height = 21
      Date = 41836.379403055560000000
      Time = 41836.379403055560000000
      TabOrder = 3
    end
  end
  object dxBarABM: TdxBarManager
    ...
    object dxBarABMBar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnVerCtaCte'
        end
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnVerDetalleFactura'
        end
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btnSaldoInicial'
        end
        item
          Visible = True
          ItemName = 'btnAltaRecibo'
        end
        item
          BeginGroup = True
          Visible = True
    ...
    object btnVerCtaCte: TdxBarLargeButton
      ...
      Category = 0
      Hint = 'Ver la cuenta corriente del proveedor seleccionado'
      Visible = ivAlways
      LargeImageIndex = 56
    ...
    object btnAltaRecibo: TdxBarLargeButton
      Caption = 'ABM Orden Pago Cta. Cte.'
      Category = 0
      Hint = 'ABM Orden Pago Cta. Cte.'
      Visible = ivAlways
      LargeImageIndex = 86
  ...
  object ZQ_CtaCte_Proveedor: TZQuery
    Connection = DM.Conexion
    AfterScroll = ZQ_CtaCte_ProveedorAfterScroll
    SQL.Strings = (
    ...
    object ZQ_CtaCte_ProveedorFECHA: TDateTimeField
      FieldName = 'FECHA'
    end
    ...
    object ZQ_CtaCte_ProveedorSUCURSAL: TStringField
      FieldName = 'SUCURSAL'
      Size = 200
    end
  end
  ...
  object ZQ_ComprobanteDetalle: TZQuery
    ...
    SQL.Strings = (
      'select cd.id_comprobante_detalle, cd.id_comprobante,'
        ...
        '       cd.importe_venta, cd.importe_unitario, cd.porc_iva, cd.ba' +
        'se_imponible'
  ...
  object DS_OrdenPagoDetalle: TDataSource
    DataSet = ZQ_OrdenPagoDetalle
    Left = 490
    Top = 361
  end
  object ZQ_OrdenPagoDetalle: TZQuery
    Connection = DM.Conexion
    SQL.Strings = (
      'select pf.*, c.importe_venta, fp.importe_real,'
      '       case'
      
        '        when (c.id_tipo_cpb = 13) then '#39'FACTURA '#39'||lpad(c.punto_' +
        'venta, 4, '#39'0'#39')||'#39'-'#39'||lpad(c.numero_cpb, 8, '#39'0'#39')'
      '        when (c.id_tipo_cpb = 26) then '#39'SALDO INICIAL CTA. CTE.'#39
      '       end as Descripcion,'
      '       case'
      
        '        when (c.id_tipo_cpb = 13) then cast(c.fecha_cobrada as D' +
        'ate)'
      '        when (c.id_tipo_cpb = 26) then cast(c.fecha as Date)'
      '       end as fecha'
    ...
    object ZQ_OrdenPagoDetalleID_PAGO_FACTURAS: TIntegerField
      FieldName = 'ID_PAGO_FACTURAS'
    end
    object ZQ_OrdenPagoDetalleID_COMPROBANTE: TIntegerField
      FieldName = 'ID_COMPROBANTE'
    end
    object ZQ_OrdenPagoDetalleID_FACTURA: TIntegerField
      FieldName = 'ID_FACTURA'
    end
    object ZQ_OrdenPagoDetalleID_TIPO_COMPROBANTE: TIntegerField
      FieldName = 'ID_TIPO_COMPROBANTE'
    end
    object ZQ_OrdenPagoDetalleIMPORTE: TFloatField
      FieldName = 'IMPORTE'
      currency = True
    end
    object ZQ_OrdenPagoDetalleFECHA: TDateTimeField
      FieldName = 'FECHA'
    end
    object ZQ_OrdenPagoDetalleIMPORTE_VENTA: TFloatField
      FieldName = 'IMPORTE_VENTA'
      currency = True
    end
    object ZQ_OrdenPagoDetalleDESCRIPCION: TStringField
      FieldName = 'DESCRIPCION'
      ReadOnly = True
      Size = 31
    end
    object ZQ_OrdenPagoDetalleIMPORTE_REAL: TFloatField
      FieldName = 'IMPORTE_REAL'
      currency = True
    end
    object ZQ_OrdenPagoDetalleDESC_REC: TFloatField
      FieldName = 'DESC_REC'
    end
  end
  ...
  object ISVistaCtasCtes: TISVistaPreviaQR
    Reporte = RepCtasCtes
    ShowModal = False
    Left = 371
    Top = 158
  end
  object ISVistaProveedor: TISVistaPreviaQR
    Reporte = RepProveedor
    ShowModal = False
    Left = 371
    Top = 214
  end
  object ISOrdenar_DetalleRecibo: TISOrdenarGrilla
    Grilla = DBGridDetalle_OP
    Filtros = <
      item
        TituloColumna = 'Fecha'
        Visible = True
    ...
    NombreGuardarConfig = 'EKOrdenar_DetalleRecibo'
  ...
  object ISOrdenar_DetalleFPago: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'EKOrdenar_DetalleFPago'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrdenar_DetalleProducto: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'EKOrdenar_DetalleProducto'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrdenar_CtaCteProveedor: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'CtaCorriente_Proveedor'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrdenar_CtaCteGral: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'CtaCorriente_General'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISDbSumaCtaCte_Proveedor: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'debe'
  ...
  object ISDbSumaCtaCte_Gral: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'debe'
  ...
  object ISBuscarProveedor: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'C'#243'digo'
        Campo = 'CODIGO_CORTO'
