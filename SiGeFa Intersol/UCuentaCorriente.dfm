object FCuentaCorriente: TFCuentaCorriente
  ...
  object PanelFiltroFechas: TPanel
    ...
    object ISDBDateTime_FiltroDesde: TISDBDateTimePicker
      ...
      Width = 115
      Height = 21
      Date = 41830.378365150460000000
      Time = 41830.378365150460000000
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Verdana'
  ...
  object PanelCliente: TPanel
    ...
    object PanelCliente_CtaCte: TPanel
      ...
      object PanelDetalleMov: TPanel
        ...
        object DBGridDetalle_Producto: TDBGrid
          ...
          Options = [dgTitles, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
          PopupMenu = Popup_ComprobanteDetalle
          TabOrder = 1
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
    ...
    object PanelCliente_Resumen: TPanel
      ...
      object PanelCliente_ResumenFiltro: TPanel
        ...
        object ISEditCliente_CantidadFiltro: TISEdit
          Tag = 99
          Left = 29
          Top = 14
          Width = 145
        ...
        object ISEditCliente_DebeFiltro: TISEdit
          Tag = 99
          Left = 186
          Top = 14
          Width = 145
        ...
        object ISEditCliente_HaberFiltro: TISEdit
          Tag = 99
          Left = 343
          Top = 14
          Width = 145
        ...
        object ISEditCliente_SaldoFiltro: TISEdit
          Tag = 99
          Left = 501
          Top = 14
          Width = 145
      ...
      object PanelCliente_ResumenTotales: TPanel
        ...
        object ISEditCliente_DebeTotal: TISEdit
          Tag = 99
          Left = 186
          Top = 14
          Width = 145
        ...
        object ISEditCliente_HaberTotal: TISEdit
          Tag = 99
          Left = 343
          Top = 14
          Width = 145
        ...
        object ISEditCliente_SaldoTotal: TISEdit
          Tag = 99
          Left = 501
          Top = 14
          Width = 145
  ...
  object ISVistaClientes: TISVistaPreviaQR
    Reporte = RepCliente
    ShowModal = False
    Left = 895
    Top = 396
  ...
  object ISOrdenar_CtaCteCliente: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'CtaCorriente_Cliente'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISDbSumaCtaCte_Cliente: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'debe'
  ...
  object ISBuscarCliente: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'C'#243'digo'
        Campo = 'CODIGO_CORTO'
