object FABM_Colores: TFABM_Colores
  ...
  object PanelFondo: TPanel
    ...
    object PanelGrilla: TPanel
      ...
      object DBGridColor: TDBGrid
        ...
        TitleFont.Style = []
        OnDrawColumnCell = DBGridColorDrawColumnCell
        Columns = <
          item
            Expanded = False
  ...
  object ZQ_Colores: TZQuery
    ...
    SQL.Strings = (
      ...
      'order by NOMBRE')
    Params = <>
    IndexFieldNames = 'CODIGO_COLOR Asc;NOMBRE Asc'
    Left = 48
    Top = 72
    ...
    object ZQ_ColoresREFERENCIA: TStringField
      FieldName = 'REFERENCIA'
      Size = 30
    end
  ...
  object ZSP_ID_COLOR: TZStoredProc
    Connection = DM.Conexion
    Params = <
      item
        DataType = ftInteger
  ...
  object ISOrdenarGrilla1: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Colores'
