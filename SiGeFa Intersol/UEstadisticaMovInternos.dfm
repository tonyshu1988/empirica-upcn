object FEstadisticaMovInternos: TFEstadisticaMovInternos
  ...
  object ISOrdenarGrillaMovimientos: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'IsOrdenarGrillaMovimientos'
  ...
  object ISOrdenarGrillaBalance: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ISOrdenarGrillaBalance'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISDbSuma_Ingresos: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'sum'
  ...
  object ISDbSuma_Egresos: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'sum'
  ...
  object ISBuscar_Mov: TISBusquedaAvanzada
    CriteriosBusqueda = <
      item
        Titulo = 'Fecha Desde'
        TipoCampo = IS_Fecha
