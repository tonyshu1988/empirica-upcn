object FArqueo_Caja: TFArqueo_Caja
  ...
  object RepArqueo: TQuickRep
    ...
    object QRBand14: TQRBand
      ...
      object RepArqueo_Titulo: TQRLabel
        Left = 443
        Top = 3
        Width = 160
        Height = 20
      ...
      object RepArqueo_Subtitulo: TQRLabel
        Left = 452
        Top = 27
        Width = 143
        Height = 20
    ...
    object QRSubDetail4: TQRSubDetail
      ...
      PrintBefore = False
      PrintIfEmpty = True
      object QRLabelImporteTotal: TQRLabel
        Left = 910
        Top = 0
        Width = 137
        Height = 17
  ...
  object RepSaldo: TQuickRep
    ...
    object QRBand9: TQRBand
      ...
      object QRLblTituloSaldo: TQRLabel
        Left = 299
        Top = 47
        Width = 119
        Height = 19
  ...
  object PanelContenedor: TPanel
    ...
    object PageControl1: TPageControl
      ...
      Width = 861
      Height = 483
      ActivePage = TabSheetMovimientos
      Align = alClient
      TabOrder = 1
      object TabSheetMovimientos: TTabSheet
        Caption = 'Movimientos de la Fecha'
      ...
      object TabSheetCuentas: TTabSheet
        Caption = 'Estado Diario de las Cuentas'
        ImageIndex = 1
        object DBGrid1: TDBGrid
          ...
          Columns = <
            ...
            item
              ...
              Title.Alignment = taCenter
              Title.Caption = 'Saldo del D'#237'a'
              Width = 136
              Visible = True
            end>
        end
  ...
  object ZQ_Arqueo_Movimientos: TZQuery
    ...
    object ZQ_Arqueo_MovimientosIMPORTE_TRANSFERIDO: TFloatField
      FieldName = 'IMPORTE_TRANSFERIDO'
      ReadOnly = True
      currency = True
    end
  ...
  object ZQ_Arqueo_Fpago: TZQuery
    Connection = DM.Conexion
    SQL.Strings = (
      'select ac.tipo_fpago, ac.fiscal, ac.cuenta,'
      '        sum(ac.importe_venta) as importe_venta,'
      '        sum(ac.importe_transferido) as importe_transferido'
      
        'from arqueo_caja_forma_pago(:fecha_arqueo, :id_sucursal_ingreso)' +
        ' ac'
      'group by ac.tipo_fpago, ac.fiscal, ac.cuenta'
      'order by 5 desc, ac.cuenta, ac.tipo_fpago')
    Params = <
      item
        DataType = ftUnknown
        Name = 'fecha_arqueo'
    ...
    object ZQ_Arqueo_FpagoTIPO_FPAGO: TStringField
      FieldName = 'TIPO_FPAGO'
      Size = 50
    end
    object ZQ_Arqueo_FpagoFISCAL: TStringField
      FieldName = 'FISCAL'
      Size = 1
    end
    object ZQ_Arqueo_FpagoCUENTA: TStringField
      FieldName = 'CUENTA'
      Size = 200
    end
    object ZQ_Arqueo_FpagoIMPORTE_VENTA: TFloatField
      FieldName = 'IMPORTE_VENTA'
      currency = True
    end
    object ZQ_Arqueo_FpagoIMPORTE_TRANSFERIDO: TFloatField
      FieldName = 'IMPORTE_TRANSFERIDO'
      currency = True
    end
  end
  object ZQ_SaldoCuenta_PDiario: TZQuery
    ...
    SQL.Strings = (
        ...
        'select sc.ID_CUENTA, sc.CODIGO, sc.NOMBRE_CUENTA, sc.NRO_CTA_BAN' +
        'CO,'
      
        '       sum(sc.SALDO) as Saldo, sum(sc.SALDO_ANTERIOR) as Saldo_A' +
        'nt,'
      '       (sum(sc.SALDO) - sum(sc.SALDO_ANTERIOR)) as diferencia'
      
        'from SALDOS_CUENTAS2(:ID_SUCURSAL, :FECHA_DESDE,  :FECHA_HASTA) ' +
        'sc'
      'left join cuenta ct on (sc.id_cuenta = ct.id_cuenta)'
      'where ct.id_sucursal = :ID_SUCURSAL'
      '   or ct.id_sucursal = 0'
      
        'group by sc.ID_CUENTA, sc.CODIGO, sc.NOMBRE_CUENTA, sc.NRO_CTA_B' +
        'ANCO'
      'order by sc.NOMBRE_CUENTA')
    Params = <
      item
        DataType = ftUnknown
        Name = 'ID_SUCURSAL'
  ...
  object ISVistaPreviaSaldo: TISVistaPreviaQR
    Reporte = RepSaldo
    ShowModal = False
    Left = 221
    Top = 396
  ...
  object ISOrdenarGrilla1: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'GrillaArqueoMovimiento'
  ...
  object ISOrdenarGrilla2: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'GrillaArqueoFormaPago'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISDbSuma_ArqueoMov: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
      ...
      item
        Operacion = goSum
        NombreCampo = 'importe_transferido'
      end>
    DataSet = ZQ_Arqueo_Movimientos
  ...
  object ISDbSuma_ArqueoFpago: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'importe_venta'
