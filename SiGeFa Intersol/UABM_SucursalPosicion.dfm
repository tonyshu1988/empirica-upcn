object FABM_SucursalPosicion: TFABM_SucursalPosicion
  ...
  object PContenedor: TPanel
    ...
    object RepSucPosicion: TQuickRep
      ...
      object QRBand9: TQRBand
        ...
        object RepSucPosicion_Subtitulo: TQRLabel
          Left = 271
          Top = 26
          Width = 175
          Height = 20
          ...
          AutoSize = True
          AutoStretch = False
          Caption = 'RepSucPosicion_Subtitulo'
          Color = clWhite
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
        ...
        object RepSucPosicion_Titulo: TQRLabel
          Left = 260
          Top = 2
          Width = 198
          Height = 20
      ...
      object QRBand12: TQRBand
        ...
        object QRExpr18: TQRExpr
          ...
          Transparent = False
          WordWrap = True
          Expression = #39'Cantidad de Posiciones: '#39'+COUNT'
          ExportAs = exptText
          FontSize = 8
        end
      end
  ...
  object ZQ_PosicionSucursal: TZQuery
  ...
  object ISListadoSucursal: TISListadoSQL
    Modelo = DM.ISModelo
    SQL.Strings = (
      'select s.*'
      'from Sucursal s'
  ...
  object ISOrdenarGrilla1: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_SucPosicion'
