object FABM_CPB_Devolucion: TFABM_CPB_Devolucion
  ...
  object ZQ_ListadoMedio: TZQuery
    ...
    object ZQ_ListadoMedioIF: TStringField
      FieldName = 'IF'
      Size = 1
    end
    object ZQ_ListadoMedioDESC_REC: TFloatField
      FieldName = 'DESC_REC'
    end
    object ZQ_ListadoMedioCOD_CORTO: TIntegerField
      FieldName = 'COD_CORTO'
    end
    object ZQ_ListadoMedioGENERA_VUELTO: TStringField
      FieldName = 'GENERA_VUELTO'
      Size = 1
    end
    object ZQ_ListadoMedioCOLUMNA_PRECIO: TIntegerField
      FieldName = 'COLUMNA_PRECIO'
    end
    object ZQ_ListadoMedioMODIFICABLE: TStringField
  ...
  object CD_Devolucion: TClientDataSet
    ...
    object CD_Devolucionimporte_if: TFloatField
      FieldName = 'importe_if'
    end
    object CD_Devolucionimporte_if_siniva: TFloatField
      FieldName = 'importe_if_siniva'
    end
    object CD_Devolucionimporte_iva_if: TFloatField
      FieldName = 'importe_iva_if'
    end
    object CD_Devolucionimporte_original: TFloatField
  ...
  object ISOrd_EditarFpago: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cpb_EditarFPago'
  ...
  object ISOrd_VerCpb: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cpb_VerCpb'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrd_EditarDevolucion: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cpb_EditarDevolucion'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrd_EditarEntrega: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cpb_EditarEntrega'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrd_VerCpb_Devolucion: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cpb_VerDevolucion'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrd_VerCpb_Entrega: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cpb_VerEntrega'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISOrd_VerCpb_Fpago: TISOrdenarGrilla
    ...
    NombreGuardarConfig = 'ABM_Cpb_VerFpago'
    AltoTituloColumna = 15
    FuenteNormal = []
    Ordenar = True
    MoverColumna = True
  ...
  object ISSuma_Entrega: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
  ...
  object ISSuma_Devolucion: TISDbSuma
    SumCollection = <
      item
        Operacion = goSum
        NombreCampo = 'cantidad'
