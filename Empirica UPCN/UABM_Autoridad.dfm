object FABM_Autoridad: TFABM_Autoridad
  Left = 317
  Top = 205
  Width = 891
  Height = 500
  ...
  object DS_Autoridad: TDataSource
    DataSet = ZQ_Autoridad
    Left = 40
    Top = 208
  end
  object ZQ_Autoridad: TZQuery
    ...
    object ZQ_AutoridadPRIORIDAD: TIntegerField
      FieldName = 'PRIORIDAD'
    end
  end
