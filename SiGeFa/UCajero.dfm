object FCajero: TFCajero
  ...
  object EKDbSumaFPago: TEKDbSuma
    ...
    DataSet = CD_Fpago
    SumListChanged = EKDbSumaFPagoSumListChanged
    Left = 316
    Top = 434
  end
  ...
  object EKDbSumaDetalleFactura: TEKDbSuma
    SumCollection = <
      item
        Operacion = goSum
    ...
    SumListChanged = EKDbSumaDetalleFacturaSumListChanged
    Left = 492
    Top = 342
  end
  ...
  object EKDbSumaVentaFinal: TEKDbSuma
    SumCollection = <
      item
        Operacion = goSum
