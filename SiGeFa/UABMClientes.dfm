object FABMClientes: TFABMClientes
  ...
  object PanelFondo: TPanel
    ...
    BorderWidth = 5
    TabOrder = 4
    object RepClientesDetalle: TQuickRep
      Tag = 99
      Left = 93
      Top = 71
      Width = 794
      ...
      object QRBand1: TQRBand
        ...
        object RepClientesDetalle_Subtitulo: TQRLabel
          Left = 261
          Top = 26
          Width = 196
          Height = 20
          ...
          AutoSize = True
          AutoStretch = False
          Caption = 'RepClientesDetalle_Subtitulo'
          Color = clWhite
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
        ...
        object RepClientesDetalle_Titulo: TQRLabel
          Left = 246
          Top = 2
          Width = 226
          Height = 20
          ...
          AutoSize = True
          AutoStretch = False
          Caption = 'RepClientesDetalle_Titulo'
          Color = clWhite
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -16
    ...
    object RepClientesListado: TQuickRep
      Tag = 99
      Left = 84
      Top = 182
      Width = 1123
      ...
      object QRBand9: TQRBand
        ...
        object RepClientesListado_Subtitulo: TQRLabel
          Left = 425
          Top = 26
          Width = 197
          Height = 20
          ...
          AutoSize = True
          AutoStretch = False
          Caption = 'RepClientesListado_Subtitulo'
          Color = clWhite
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
        ...
        object RepClientesListado_Titulo: TQRLabel
          Left = 409
          Top = 2
          Width = 228
          Height = 20
          ...
          AutoSize = True
          AutoStretch = False
          Caption = 'RepClientesListado_Titulo'
          Color = clWhite
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -16
      ...
      object QRBand12: TQRBand
        ...
        object QRExpr18: TQRExpr
          ...
          Transparent = False
          WordWrap = True
          Expression = #39'Cantidad de Clientes: '#39'+COUNT'
          ExportAs = exptText
          FontSize = 8
        end
      end
  ...
  object ZQ_Clientes: TZQuery
    ...
    Left = 64
    Top = 72
    object ZQ_ClientesID_PERSONA: TIntegerField
      FieldName = 'ID_PERSONA'
    end
    object ZQ_ClientesID_PROVINCIA: TIntegerField
      FieldName = 'ID_PROVINCIA'
    end
    object ZQ_ClientesID_TIPO_DOC: TIntegerField
      FieldName = 'ID_TIPO_DOC'
    end
    object ZQ_ClientesID_TIPO_IVA: TIntegerField
    ...
    object ZQ_ClientesFECHA_NACIMIENTO: TDateField
      FieldName = 'FECHA_NACIMIENTO'
    end
    ...
    object ZQ_ClientesSEXO: TStringField
      FieldName = 'SEXO'
      Size = 1
    end
    object ZQ_ClientesDESCRIPCION: TStringField
    ...
    object ZQ_ClientesBAJA: TStringField
      FieldName = 'BAJA'
      Size = 1
    end
  ...
  object Nro_Cliente: TZStoredProc
    Connection = DM.Conexion
    Params = <
      item
        DataType = ftInteger
    ...
    object Nro_ClienteID: TIntegerField
      FieldName = 'ID'
    end
  end
  object ZU_Clientes: TZUpdateSQL
    DeleteSQL.Strings = (
      'DELETE FROM persona'
      'WHERE'
  ...
  object EKVistaPreviaListado: TEKVistaPreviaQR
    Reporte = RepClientesListado
    ShowModal = False
    Left = 498
    Top = 121
  end
  object EKVistaPreviaDetalle: TEKVistaPreviaQR
    Reporte = RepClientesDetalle
    ShowModal = False
    Left = 498
    Top = 169
  end
