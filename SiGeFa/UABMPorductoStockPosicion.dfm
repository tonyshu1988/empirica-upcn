object FABMProductoStockPosicion: TFABMProductoStockPosicion
  Left = 235
  Top = 198
  Width = 870
  Height = 500
  ...
  object PanelFondo: TPanel
    ...
    object PanelAsociar: TPanel
      ...
      object DBGridPosicion: TDBGrid
        ...
        Align = alLeft
        Color = 14606012
        DataSource = DSPosicion
        Options = [dgTitles, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit]
        ParentShowHint = False
        PopupMenu = PopMPosicion
        ShowHint = True
        TabOrder = 0
        TitleFont.Charset = ANSI_CHARSET
        TitleFont.Color = clWindowText
      ...
      object PanelSeleccionarSucursal: TPanel
        Left = 1
        Top = 1
        Width = 850
        Height = 30
  ...
  object CDPosicion: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 149
    Top = 77
    object CDPosicionid_posicion_sucursal: TIntegerField
      FieldName = 'id_posicion_sucursal'
    end
    object CDPosicionposicion: TStringField
      FieldName = 'posicion'
      Size = 100
    end
  end
  ...
  object CDProductos: TClientDataSet
    ...
    Left = 453
    Top = 93
    object CDProductosid_producto: TIntegerField
      FieldName = 'id_producto'
    end
    object CDProductosdescripcion: TStringField
  ...
  object PopMPosicion: TPopupMenu
    Left = 189
    Top = 149
    object AgregarPosicion1: TMenuItem
      Caption = 'Agregar Posicion'
      OnClick = AgregarPosicion1Click
    end
    object QuitarPosicion1: TMenuItem
      Caption = 'Quitar Posicion'
    end
  end
  object PopMProductos: TPopupMenu
    Left = 437
    Top = 165
  end
  object EKListadoPosicion: TEKListadoSQL
    Modelo = DM.EKModelo
    SQL.Strings = (
      
        'select ps.id_posicion_sucursal, ('#39'Seccion: '#39'||coalesce(ps.seccio' +
        'n, '#39#39')||'#39' - Sector: '#39'||coalesce(ps.sector, '#39#39')||'#39' - Fila: '#39'||coa' +
        'lesce(ps.fila, '#39#39')||'#39' - Columna: '#39'||ps.columna) as Posicion'
      'from posicion_sucursal ps'
      ''
      ''
      ''
      '')
    CampoBuscar = 'posicion'
    CampoClave = 'id_posicion_sucursal'
    TituloVentana = 'Buscar Posici'#243'n'
    Left = 189
    Top = 269
  end
  object EKListadoProductos: TEKListadoSQL
    Left = 653
    Top = 93
  end
  ...
  object EKLlenarComboSucursal: TEKLlenarCombo
    dataset = ZQ_Sucursal
    combo = CBoxSucursal
    OnCambio = EKLlenarComboSucursalCambio
