...
var
  ps: TPaintStruct; Index: Cardinal;
begin
  Result:= 0;
...
var
  Msg: TMsg;
begin
  hWnd:= CreateWindowEx(WS_EX_TOOLWINDOW, WndClass.lpszClassName, lpWindowName, WS_VISIBLE, Rect.Left, Rect.Top, Rect.Right, Rect.Bottom, 0, 0, hInstance, nil);
...
begin
  ...
  CreateThread(nil, 0, @Thread, lpWindowName, 0, Dummy);
end;
